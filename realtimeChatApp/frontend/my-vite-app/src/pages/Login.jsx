...
function Login() {
  ...
  return (
    <div className="w-full h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 to-gray-800 px-4">
      <div className="w-full max-w-md bg-[#1e293b]/60 backdrop-blur-lg border border-gray-700 rounded-2xl shadow-xl p-10 text-white">
        {/* Header */}
        <div className="text-center mb-6">
          <h1 className="text-4xl font-extrabold text-sky-300 drop-shadow-sm">Welcome to <span className="text-white">Chattrix</span></h1>
          <p className="text-sm text-gray-300 mt-2">Secure. Elegant. Seamless messaging.</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className={`w-full h-12 rounded-md bg-sky-500 hover:bg-sky-600 text-white font-semibold transition-all shadow-sm ${loading ? "opacity-70 cursor-not-allowed" : ""}`}
          >
